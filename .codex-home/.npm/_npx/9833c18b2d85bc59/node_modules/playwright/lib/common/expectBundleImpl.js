...
`,"")},Wf=e=>function(t,n){let s={isNot:this.isNot,promise:this.promise};(0,_.ensureNoExpected)(n,e,s),ur(t,e,"",s);let o=_n(t),i=o?"spy":t.getMockName(),u=o?t.calls.count():t.mock.calls.length,a=o?t.calls.all().map(f=>f.args):t.mock.calls,l=u>0;return{message:l?()=>(0,_.matcherHint)(e,i,"",s)+`
...
`):()=>(0,_.matcherHint)(e,i,"",s)+`

Expected number of calls: >= ${(0,_.printExpected)(1)}
Received number of calls:    ${(0,_.printReceived)(u)}`,pass:l}},Vf=e=>function(t,n){let s={isNot:this.isNot,promise:this.promise};(0,_.ensureNoExpected)(n,e,s),ar(t,e,"",s);let o=t.getMockName(),i=t.mock.results.reduce((l,c)=>c.type==="return"?l+1:l,0),u=i>0;return{message:u?()=>(0,_.matcherHint)(e,o,"",s)+`
...
Received number of calls:   ${(0,_.printReceived)(t.mock.calls.length)}`:""):()=>(0,_.matcherHint)(e,o,"",s)+`
...
Expected: ${(0,_.printExpected)(n)}
`+En("Received: ",n,f,u.length===1,a)+bn(yn(u),i.length)},pass:l}},Zf=e=>function(t,n,...r){let o={expectedColor:m=>m,isNot:this.isNot,promise:this.promise,secondArgument:"...expected"};if(ur(t,e,"n",o),!Number.isSafeInteger(n)||n<1)throw new Error((0,_.matcherErrorMessage)((0,_.matcherHint)(e,void 0,"n",o),"n must be a positive integer",(0,_.printWithType)("n",n,_.stringify)));let i=_n(t),u=i?"spy":t.getMockName(),a=i?t.calls.all().map(m=>m.args):t.mock.calls,l=a.length,c=n-1,f=c<l&&vt(r,a[c]);return{message:f?()=>{let m=[];return c-1>=0&&m.push([c-1,a[c-1]]),m.push([c,a[c]]),c+1<l&&m.push([c+1,a[c+1]]),(0,_.matcherHint)(e,u,"n",o)+`

n: ${n}
Expected: not ${Ls(r)}
`+(a.length===1&&(0,_.stringify)(a[0])===(0,_.stringify)(r)?"":Xi(r,m,a.length===1,c))+`
Number of calls: ${(0,_.printReceived)(a.length)}`}:()=>{let m=[];if(c<l){if(c-1>=0){let h=c-1;for(;h>=0&&!vt(r,a[h]);)h-=1;h<0&&(h=c-1),m.push([h,a[h]])}if(m.push([c,a[c]]),c+1<l){let h=c+1;for(;h<l&&!vt(r,a[h]);)h+=1;h>=l&&(h=c+1),m.push([h,a[h]])}}else if(l>0){let h=l-1;for(;h>=0&&!vt(r,a[h]);)h-=1;h<0&&(h=l-1),m.push([h,a[h]])}return(0,_.matcherHint)(e,u,"n",o)+`

n: ${n}
`+Ji(r,m,Yi(this.expand),a.length===1,c)+`
Number of calls: ${(0,_.printReceived)(a.length)}`},pass:f}},ep=e=>function(t,n,r){let o={expectedColor:m=>m,isNot:this.isNot,promise:this.promise,secondArgument:"expected"};if(ar(t,e,"n",o),!Number.isSafeInteger(n)||n<1)throw new Error((0,_.matcherErrorMessage)((0,_.matcherHint)(e,void 0,"n",o),"n must be a positive integer",(0,_.printWithType)("n",n,_.stringify)));let i=t.getMockName(),{calls:u,results:a}=t.mock,l=a.length,c=n-1,f=c<l&&_t(r,a[c]);return{message:f?()=>{let m=[];return c-1>=0&&m.push([c-1,a[c-1]]),m.push([c,a[c]]),c+1<l&&m.push([c+1,a[c+1]]),(0,_.matcherHint)(e,i,"n",o)+`

n: ${n}
Expected: not ${(0,_.printExpected)(r)}
`+(a.length===1&&a[0].type==="return"&&(0,_.stringify)(a[0].value)===(0,_.stringify)(r)?"":En("Received:     ",r,m,a.length===1,c))+bn(yn(a),u.length)}:()=>{let m=[];if(c<l){if(c-1>=0){let h=c-1;for(;h>=0&&!_t(r,a[h]);)h-=1;h<0&&(h=c-1),m.push([h,a[h]])}if(m.push([c,a[c]]),c+1<l){let h=c+1;for(;h<l&&!_t(r,a[h]);)h+=1;h>=l&&(h=c+1),m.push([h,a[h]])}}else if(l>0){let h=l-1;for(;h>=0&&!_t(r,a[h]);)h-=1;h<0&&(h=l-1),m.push([h,a[h]])}return(0,_.matcherHint)(e,i,"n",o)+`
