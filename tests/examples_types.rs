// パス: tests/examples_types.rs
// 役割: Snapshot-style tests for bundled example programs
// 意図: Ensure documented samples retain their types and values
// 関連ファイル: examples/basics.tl, examples/advanced.tl, src/infer.rs, src/evaluator.rs
